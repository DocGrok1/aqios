...
DEVICE_REGISTRY = {
    ...
    "uranus":   {"arn": "arn:aws:braket:eu-north-1::device/qpu/aqt/IBEX_Q1",       "type": "qpu",               "vendor": "AQT",     "substrate": "Trapped Ion", "shards": 4, "shard_qubits": 12, "qubits": 48, "parallel": True},
